...
private:
    ...
    bool parse_response(Exchange exchange, const std::string& json, OrderBook& book) {
        ...
        switch (exchange) {
            case Exchange::COINBASE: return parse_generic_array(json, book);
            case Exchange::GEMINI: return parse_gemini(json, book);
            case Exchange::KRAKEN: return parse_kraken(json, book);
            case Exchange::BITSTAMP: return parse_generic_array(json, book);
            case Exchange::OKX:
            case Exchange::MYOKX:
            case Exchange::OKXUS: return parse_okx(json, book);
            case Exchange::HTX:
            case Exchange::HUOBI: return parse_htx(json, book);
            case Exchange::KUCOIN:
            case Exchange::KUCOINFUTURES: return parse_generic_data(json, book);
            case Exchange::GATE:
            case Exchange::GATEIO: return parse_generic_array(json, book);
            case Exchange::MEXC: return parse_mexc(json, book);
            case Exchange::BITGET: return parse_generic_data(json, book);
            case Exchange::PHEMEX: return parse_phemex(json, book);
            case Exchange::DERIBIT: return parse_deribit(json, book);
            case Exchange::POLONIEX: return parse_poloniex(json, book);
            case Exchange::BITFINEX: return parse_bitfinex(json, book);
            case Exchange::COINEX: return parse_coinex(json, book);
            case Exchange::BINGX: return parse_generic_data(json, book);
            case Exchange::BITMART: return parse_generic_data(json, book);
            case Exchange::LBANK: return parse_generic_data(json, book);
            case Exchange::WHITEBIT: return parse_generic_array(json, book);
            case Exchange::CRYPTOCOM: return parse_cryptocom(json, book);
            case Exchange::XT: return parse_generic_data(json, book);
            case Exchange::PROBIT: return parse_generic_data(json, book);
            case Exchange::ASCENDEX: return parse_ascendex(json, book);
            case Exchange::ZEBPAY: return parse_zebpay(json, book);
            default: return parse_generic_array(json, book);
        }
    }
